...
- If `vendor/openai-codex` is empty, uninitialized, or otherwise invalid in the current worktree, do not use it to decide whether a new upstream release exists.
