...
public struct RealtimeSessionStartedThreadRealtimeItem2: ObjectModel {
    ...
    public var rawJSON: JSONValue {
        .object(mergedJSONObject(payload, additionalFields: additionalFields, context: "RealtimeSessionStartedThreadRealtimeItem2"))
    }
    ...
    public func encode(to encoder: any Encoder) throws {
        try encodeJSONObject(payload, additionalFields: additionalFields, context: "RealtimeSessionStartedThreadRealtimeItem2", to: encoder)
    }
